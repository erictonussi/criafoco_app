  ...
  .run(function ($ionicPlatform, $translate, $cordovaGlobalization, $state, $rootScope, ngFB, Config, ga, $ionicDeploy) {
    ...
    $ionicPlatform.ready(function () {
      ...
      if (window.StatusBar && ionic.Platform.isAndroid()) {
        window.StatusBar.backgroundColorByHexString('#1c3aa9');
      }
      ...
      $rootScope.$on('$ionicView.beforeEnter', function () {
        ...
        if (window.StatusBar && ionic.Platform.isAndroid()) {
          switch ($state.current.name) {
            case 'tab.facts':
              window.StatusBar.backgroundColorByHexString('#b53926');
              break;
            case 'tab.notes':
              window.StatusBar.backgroundColorByHexString('#086cb3');
              break;
            case 'tab.creation':
              window.StatusBar.backgroundColorByHexString('#ebc57e');
              break;
            case 'tab.usage':
              window.StatusBar.backgroundColorByHexString('#18a69f');
              break;
            case 'tab.script':
              window.StatusBar.backgroundColorByHexString('#f27921');
              break;
            default: window.StatusBar.backgroundColorByHexString('#1c3aa9');
              break;
          }
        }
