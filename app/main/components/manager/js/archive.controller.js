appControllers.controller('ArchiveCtrl', ['$scope', '$rootScope', '$state', '$ionicPopup', '$translate', 'localStorageService', 'personManager', 'projetoManager', function ($scope, $rootScope, $state, $ionicPopup, $translate, localStorageService, personManager, projetoManager) {
  var strings = {};
  var someOpen = false;
