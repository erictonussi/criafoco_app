appControllers.controller('TabFactsCtrl', ['$scope', '$rootScope', '$state', '$timeout', '$interval', '$ionicModal', '$ionicPopup', '$ionicPopover', '$translate', 'localStorageService', 'tipoRegistroManager', 'registroManager', 'projetoManager', function($scope, $rootScope, $state, $timeout, $interval, $ionicModal, $ionicPopup, $ionicPopover, $translate, localStorageService, tipoRegistroManager, registroManager, projetoManager) {
