appControllers.controller('TabUsageCtrl', ['$scope', '$rootScope', '$state', '$timeout', '$ionicModal', '$ionicPopup', '$translate', 'tipoRegistroManager', 'registroManager', 'criterioManager', 'notaManager', 'projetoManager', 'localStorageService', function($scope, $rootScope, $state, $timeout, $ionicModal, $ionicPopup, $translate, tipoRegistroManager, registroManager, criterioManager, notaManager, projetoManager, localStorageService) {
    ...
    var finishPopup = function() {
        var finishPopup = $ionicPopup.confirm({
