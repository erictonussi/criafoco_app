appServices.factory('criterioManager', ['Criterio', 'Nota', '$q', 'localStorageService', function(Criterio, Nota, $q, localStorageService) {
    var criterioManager = {
        /**
        ...
        getAll: function(projeto) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                var list = localStorageService.get('criterio').filter(x => x.projeto == projeto.id || x.projeto == null);
        ...
        getById: function(id) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                var criterio = localStorageService.get('criterio').find(x => x.id == id);
                defer.resolve(criterio);
            }
        ...
        remove: function(criterio) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                var index = criterios.findIndex(x => x.id == criterio.id);
