    ...
    var registroManager = {
        ...
        getAll: function(projeto, tipo, descarte) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                if (list == undefined) {
                    ...
                    list = list.filter(x => x.projeto == projeto.id && x.tipo == tipo.id && x.descarte == descarte);
                }
        ...
        save: function(registro) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                var index = list.findIndex(x => x.id == registro.id);
        ...
        remove: function(registro) {
            ...
            if (Constants.dataSource == "sqlite") {
                ...
                if (notas != undefined) {
                    var update = notas.filter(x => x.registro != registro.id);
